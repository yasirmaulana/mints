...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</header><div style="${ssrRenderStyle({ "padding-top": "88px" })}"><div class="px-5 py-16 md:px-12" style="${ssrRenderStyle({ "border-bottom": "1px solid rgba(9,11,12,0.08)" })}"><div class="mx-auto max-w-5xl"><div class="mb-4 flex items-center gap-3"><div class="h-px w-5" style="${ssrRenderStyle({ "background": "rgba(9,11,12,0.6)" })}"></div><span class="text-xs font-normal uppercase tracking-[0.16rem]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.5)" })}">Kebijakan</span></div><h1 class="text-[2.5rem] font-normal leading-tight tracking-tight md:text-[4rem]"> Kebijakan<br><em style="${ssrRenderStyle({ "font-style": "italic", "opacity": "0.5" })}">Privasi</em></h1><p class="mt-4 text-sm max-w-md leading-relaxed" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.55)" })}"> Mints sangat menghormati dan menjaga privasi pelanggan kami. Halaman ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda. </p><p class="mt-3 text-xs" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.35)" })}">Pembaruan Terakhir: 1 April 2026</p></div></div><section class="px-5 py-16 md:px-12"><div class="mx-auto max-w-3xl space-y-4"><!--[-->`);
      ssrRenderList(sections, (section, i) => {
        _push(`<div class="rounded-3xl p-8" style="${ssrRenderStyle({ "background": "white" })}"><div class="flex items-start gap-5 mb-5"><span class="flex-shrink-0 w-8 h-8 rounded-2xl flex items-center justify-center text-xs font-bold" style="${ssrRenderStyle({ "background": "#090b0c", "color": "white" })}">${ssrInterpolate(i + 1)}</span><h2 class="text-base font-semibold tracking-tight pt-1">${ssrInterpolate(section.title)}</h2></div><div class="pl-13"><p class="text-sm leading-[1.9]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.65)", "padding-left": "3.25rem" })}">${section.body ?? ""}</p></div></div>`);
      });
      _push(`<!--]--></div></section><section class="px-5 pb-24 md:px-12"><div class="mx-auto max-w-5xl"><div class="rounded-3xl px-10 py-14 text-center" style="${ssrRenderStyle({ "background": "#090b0c" })}"><p class="text-xs uppercase tracking-widest mb-3" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.4)" })}">Ada pertanyaan terkait privasi?</p><h2 class="text-2xl font-normal tracking-tight text-white mb-6 md:text-3xl">Hubungi kami kapan saja.</h2><a href="mailto:hello@mints.id" class="inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-normal transition-opacity hover:opacity-85" style="${ssrRenderStyle({ "background": "white", "color": "#090b0c" })}"> hello@mints.id <span class="flex h-5 w-5 items-center justify-center rounded-full text-xs" style="${ssrRenderStyle({ "background": "#090b0c", "color": "white" })}">→</span></a></div></div></section></div><footer class="overflow-hidden px-5 pt-20 pb-10 md:px-12" style="${ssrRenderStyle({ "background": "#f5f5f2", "border-top": "1px solid rgba(9,11,12,0.08)" })}"><div class="mx-auto max-w-5xl"><div class="grid gap-12 sm:grid-cols-3 mb-12"><div><p class="font-black text-xl tracking-tighter mb-3" style="${ssrRenderStyle({ "font-family": "'Inter Tight',sans-serif", "letter-spacing": "-0.04em" })}">MINTS</p><p class="text-sm leading-6" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.5)" })}">Elegan. Syar&#39;i.<br>Dibuat Sepenuh Hati.</p></div><div><p class="mb-4 text-xs font-normal uppercase tracking-[0.16rem]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.4)" })}">Belanja</p><ul class="space-y-3 text-sm" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.6)" })}"><li>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/koleksi",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/privasi.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=privasi-BxdZOU93.js.map
