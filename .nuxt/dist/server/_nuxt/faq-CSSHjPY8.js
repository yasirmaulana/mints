...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</header><div style="${ssrRenderStyle({ "padding-top": "88px" })}"><div class="px-5 py-16 md:px-12" style="${ssrRenderStyle({ "border-bottom": "1px solid rgba(9,11,12,0.08)" })}"><div class="mx-auto max-w-5xl"><div class="mb-4 flex items-center gap-3"><div class="h-px w-5" style="${ssrRenderStyle({ "background": "rgba(9,11,12,0.6)" })}"></div><span class="text-xs font-normal uppercase tracking-[0.16rem]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.5)" })}">Bantuan</span></div><h1 class="text-[2.5rem] font-normal leading-tight tracking-tight md:text-[4rem]"> Pertanyaan yang<br><em style="${ssrRenderStyle({ "font-style": "italic", "opacity": "0.5" })}">Sering Diajukan</em></h1><p class="mt-4 text-sm max-w-md leading-relaxed" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.55)" })}"> Temukan jawaban untuk pertanyaan umum tentang produk, pengiriman, dan layanan kami. </p></div></div><section class="px-5 py-16 md:px-12"><div class="mx-auto max-w-3xl"><div class="space-y-3"><!--[-->`);
      ssrRenderList(faqs, (item, i) => {
        _push(`<div class="rounded-3xl overflow-hidden transition-all" style="${ssrRenderStyle({ "background": "white" })}"><button class="w-full flex items-center justify-between gap-4 px-8 py-6 text-left"><span class="text-sm font-semibold leading-snug pr-2">${ssrInterpolate(item.q)}</span><span class="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-transform duration-200" style="${ssrRenderStyle(unref(open) === i ? "background:#090b0c;transform:rotate(45deg)" : "background:#f5f5f2")}"><svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="${ssrRenderStyle(unref(open) === i ? "color:white" : "color:#090b0c")}"><path d="M12 5v14M5 12h14"></path></svg></span></button><div class="px-8 pb-6" style="${ssrRenderStyle(unref(open) === i ? null : { display: "none" })}"><div class="h-px mb-5" style="${ssrRenderStyle({ "background": "rgba(9,11,12,0.06)" })}"></div><p class="text-sm leading-[1.9]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.65)" })}">${item.a ?? ""}</p></div></div>`);
      });
      _push(`<!--]--></div></div></section><section class="px-5 pb-24 md:px-12"><div class="mx-auto max-w-5xl"><div class="rounded-3xl px-10 py-14 text-center" style="${ssrRenderStyle({ "background": "#090b0c" })}"><p class="text-xs uppercase tracking-widest mb-3" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.4)" })}">Masih ada pertanyaan?</p><h2 class="text-2xl font-normal tracking-tight text-white mb-6 md:text-3xl">Kami siap membantu Anda.</h2><a href="https://wa.me/6281234567890" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-normal transition-opacity hover:opacity-85" style="${ssrRenderStyle({ "background": "white", "color": "#090b0c" })}"> Hubungi via WhatsApp <span class="flex h-5 w-5 items-center justify-center rounded-full text-xs" style="${ssrRenderStyle({ "background": "#090b0c", "color": "white" })}">→</span></a></div></div></section></div><footer class="overflow-hidden px-5 pt-20 pb-10 md:px-12" style="${ssrRenderStyle({ "background": "#f5f5f2", "border-top": "1px solid rgba(9,11,12,0.08)" })}"><div class="mx-auto max-w-5xl"><div class="grid gap-12 sm:grid-cols-3 mb-12"><div><p class="font-black text-xl tracking-tighter mb-3" style="${ssrRenderStyle({ "font-family": "'Inter Tight',sans-serif", "letter-spacing": "-0.04em" })}">MINTS</p><p class="text-sm leading-6" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.5)" })}">Elegan. Syar&#39;i.<br>Dibuat Sepenuh Hati.</p></div><div><p class="mb-4 text-xs font-normal uppercase tracking-[0.16rem]" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.4)" })}">Belanja</p><ul class="space-y-3 text-sm" style="${ssrRenderStyle({ "color": "rgba(9,11,12,0.6)" })}"><li>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/koleksi",
...
//# sourceMappingURL=faq-CSSHjPY8.js.map
